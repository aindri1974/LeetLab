...
import { useNavigate, NavLink } from 'react-router'; // Using react-router-dom
import { useEffect, useState } from 'react';
import { registerUser } from '../authSlice';

// Updated Schema Validation with more descriptive messages
...
// Reusable Eye icons for password visibility toggle
const EyeOpenIcon = () => (
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#1A1A1A] text-gray-200">
      <div className="w-full max-w-md p-8 space-y-8 bg-[#282828] rounded-lg border border-neutral-800">
        <div className="text-center">
            <h1 className="text-3xl font-bold text-yellow-500">Create an Account</h1>
            <p className="mt-2 text-gray-400">to start your LeetCode journey</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              type="text"
              placeholder="John"
              className={`${inputClasses} ${errors.firstName ? errorInputClasses : 'border-neutral-700'}`}
              {...register('firstName')}
            />
            {errors.firstName && (
        ...
        <p className="text-center text-sm text-gray-400">
          ...
          <NavLink to="/login" className="font-medium text-yellow-500 hover:underline">
            Sign In
          </NavLink>
        </p>
      </div>
